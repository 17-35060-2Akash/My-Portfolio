...
const SingleProject = () => {
    ...
    return (
        <div className=''>
            <div>
                <p data-aos="zoom-in-right" className='text-2xl md:px-4 md:text-3xl mt-20 mb-5 font-lighter uppercase pb-3' >
                    <span className='bg-white px-1.5 py-2 pb-2.5 pt-2.5 md:pt-2'>
                        <span className='bg-secondary px-3.5 pb-1 pt-1 md:pt-0.5'>Project</span>
                ...
                <p
                    ...
                    className='text-3xl uppercase font-medium mb-20 mt-10'> {name}</p>
            ...
            <div
                ...
                <p className='text-2xl md:px-4 md:text-3xl my-20 font-lighter uppercase pb-3' >
                    <span className='bg-white px-1.5 py-2 pb-2.5 pt-2.5 md:pt-2'>
                        <span className='bg-primary px-3.5 pb-1 pt-1 md:pt-0.5'>Project</span>
                        <span className='text-black font-bold pr-1'> Links</span>
                    </span>
                    {/*  <span className='bg-white px-2 py-2 pb-3 pt-3.5 md:pt-2.5'>
                        <span className='bg-primary px-3 pb-1 pt-1.5 md:pt-0.5'>Project</span>
