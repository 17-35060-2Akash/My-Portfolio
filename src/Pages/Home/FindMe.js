        ...
        <div className='mb-20 md:mb-36'>
            <p className='text-2xl md:px-4 md:text-3xl mt-40 mb-16 font-lighter uppercase pb-3' >
                <span className='bg-white px-2 py-2 pb-3'>
                    <span className='bg-secondary px-4 pb-1'>Find Me</span>
            ...
            <a href={'https://www.linkedin.com/in/nasin-ayenul-akash/'} target="_blank" rel="noopener noreferrer">
                <button className='btn btn-primary hover:btn-secondary text-white m-5 px-10 rounded-none w-64 '><FaLinkedin className='text-2xl mr-2 '></FaLinkedin> LinkedIn</button>
            </a>
            <a href={'https://www.facebook.com/nasin.akash/'} target="_blank" rel="noopener noreferrer">
                <button className='btn btn-primary hover:btn-secondary text-white m-5 px-10 rounded-none w-64 '><FaFacebook className='text-2xl mr-2 '></FaFacebook> Facebook</button>
            </a>
            <a href={'https://na.akash715@gmail.com'} target="_blank" rel="noopener noreferrer">
                <button className='btn btn-primary hover:btn-secondary text-white m-5 px-10 rounded-none w-64 '><FaMailBulk className='text-2xl mr-2 '></FaMailBulk> Gmail</button>
            </a>
